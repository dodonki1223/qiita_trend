...
module QiitaTrend
  class Target
    ...
    def initialize(trend_type = QiitaTrend::TrendType::DAILY)
      ...
      @need_login = trend_type != QiitaTrend::TrendType::DAILY
    ...
    def trend_url(type)
      case type
      when QiitaTrend::TrendType::DAILY then 'https://qiita.com/'
      when QiitaTrend::TrendType::WEEKLY then 'https://qiita.com/?scope=weekly'
      when QiitaTrend::TrendType::MONTHLY then 'https://qiita.com/?scope=monthly'
      end
    end
